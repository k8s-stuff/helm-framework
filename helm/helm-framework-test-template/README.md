...
| jobs[0].envVars.JOB_ATTEMPT | int | `1` |  |
| jobs[0].envVars.JOB_MODE | string | `"migrate"` |  |
...
| lifecycle | object | `{}` |  |
| liquibase.changelog.file | string | `"liquibase/changelog.xml"` |  |
| liquibase.database.host | string | `"sql-server"` |  |
| liquibase.database.name | string | `"SmokeTestStore"` |  |
| liquibase.database.password | string | `"smoke-test-password"` |  |
| liquibase.database.port | int | `1433` |  |
| liquibase.database.urlTemplate | string | `"jdbc:sqlserver://{host}:{port};database={name};"` |  |
| liquibase.database.userName | string | `"sa"` |  |
| liquibase.enabled | bool | `true` |  |
| liquibase.migrations.paths[0] | string | `"liquibase/migrations/*.sql"` |  |
...
| sidecars[0].envVars.PROXY_MODE | string | `"transparent"` |  |
| sidecars[0].envVars.foo | string | `"sidecar-bar"` |  |
