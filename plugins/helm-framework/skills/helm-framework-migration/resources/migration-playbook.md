...
for version `1.4.0` — the version baked into Phase 0's comparison below.
...
2. The version this skill was generated against: `1.4.0`.
...
- **newest > `1.4.0` (this skill's own baked version)** — the installed
...
- **every lookup failed** — degrade to comparing the pin against `1.4.0`
