...
for version `1.2.1` — the version baked into Phase 0's comparison below.
...
2. The version this skill was generated against: `1.2.1`.
...
- **newest > `1.2.1` (this skill's own baked version)** — the installed
...
- **every lookup failed** — degrade to comparing the pin against `1.2.1`
