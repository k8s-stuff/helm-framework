# helm-framework values contract (v1.3.0)
...
- `liquibase.database.existingSecret.usernameKey`
- `liquibase.database.host`
- `liquibase.database.name`
- `liquibase.database.password`
- `liquibase.database.port`
- `liquibase.database.url`
- `liquibase.database.urlTemplate`
- `liquibase.database.userName`
- `liquibase.enabled`
- `liquibase.extraEnvFrom`
- `liquibase.extraEnvVars`
- `liquibase.image`
- `liquibase.image.pullPolicy`
- `liquibase.image.repository`
- `liquibase.image.tag`
- `liquibase.log`
- `liquibase.log.level`
- `liquibase.migrations`
- `liquibase.migrations.files`
- `liquibase.migrations.mountPath`
- `liquibase.migrations.paths`
- `liquibase.name`
- `liquibase.resources`
- `liquibase.restartPolicy`
